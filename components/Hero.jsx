  ...
  return (
    ...
    >
      ...
      >
        <a
          href="#proyectos"
          className="inline-flex items-center gap-2 bg-accent text-bg font-syne font-bold text-sm px-7 py-3.5 rounded-full hover:bg-accent/90 hover:scale-[1.03] active:scale-95 transition-all duration-200"
        >
          {lang === 'es' ? 'Ver proyectos' : 'View projects'}
        </a>
        <a
          href="#contacto"
          className="inline-flex items-center gap-2 border border-border text-text font-syne font-bold text-sm px-7 py-3.5 rounded-full hover:border-accent/50 hover:text-accent transition-all duration-200"
        >
      ...
      >
        ...
        <p className="text-[10px] md:text-[11px] text-right leading-snug text-muted/90">
          {lang === 'es'
