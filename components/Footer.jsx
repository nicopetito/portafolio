  ...
  return (
    <footer className="px-6 md:px-12 py-10 md:py-12 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3">
      <p className="text-muted text-xs font-jakarta">
        ...
        {lang === 'es' ? 'Hecho en Mar del Plata' : 'Made in Mar del Plata'}
      </p>
      <div className="flex items-center gap-4">
        <a
          ...
          className="inline-flex items-center gap-1.5 text-muted hover:text-accent text-xs font-jakarta transition-colors duration-200"
        >
